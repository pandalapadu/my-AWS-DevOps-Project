for Creation of tags 1A--> kubectl label node ip-192-168-38-70.ec2.internal project=roboshop
...
-> kubectl taint node ip-192-168-38-70.ec2.internal project=roboshop:NoSchedule 
for Taint nodes if we pass NoExecute  (already running pods on this node evicted) 
-> kubectl taint node ip-192-168-38-70.ec2.internal project=roboshop:NoExecute
